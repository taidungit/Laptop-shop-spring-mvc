                            ...
                            <form:form method="post" action="/admin/product/update" modelAttribute="newProduct" class="row"  enctype="multipart/form-data">
                                ...
                                <div class="mb-3" style="display: none;">
                                    ...
                                    <div class="mb-3 col-12 " >
                                        ...
                                        <form:textarea type="text" path="detailDesc" class="form-control ${not empty errorDetail ?'is-invalid':''}"/>
                                        ${errorDetail}
                                    </div>
                                    <div class="mb-3 col-12 col-md-6">
                                        <label class="form-label">Short description:</label>
                                        <form:input type="text" path="shortDesc" class="form-control ${not empty errorShort ?'is-invalid':''}"/>
                                        ${errorShort}
                                    </div>
                              
                                <div class="mb-3 col-12 col-md-6">
                                    <label class="form-label">Quantity:</label>
                                    <form:input type="number" path="quantity" class="form-control ${not empty errorQuan ?'is-invalid':''}"/>
                                    ${errorQuan}
                                </div>
