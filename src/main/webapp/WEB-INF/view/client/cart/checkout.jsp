                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                       <a href="/product/${cartDetail.product.id}" target="_blank" > <img src="/images/product/${cartDetail.product.image}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px; object-fit:cover" alt=""></a>
                                    </div>
                                </th>
                                <td>
                                    <p class="mb-0 mt-4"><a href="/product/${cartDetail.product.id}" target="_blank">${cartDetail.product.name}</a></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4">
                                ...
                                <td>
                                   <form method="post" action="/delete-cart/${cartDetail.id}">
