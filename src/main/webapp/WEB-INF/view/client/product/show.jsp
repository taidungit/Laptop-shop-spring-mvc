                                             ...
                                             <div class="pagination d-flex justify-content-center mt-5">
                                                 <li class="page-item">
                                                     <a class="${1 eq currentPage ? 'disabled page-link' : 'page-link'}"
                                                         href="/products?page=${currentPage - 1}"  ${currentPage == 1 ? 'onclick="return false;"' : ''} aria-label="Previous">
                                                 ...
                                                 <li class="page-item">
                                                     <a class="${totalPages eq currentPage ? 'disabled page-link' : 'page-link'}"
                                                         href="/products?page=${currentPage + 1}"  ${currentPage == totalPages ? 'onclick="return false;"' : ''} aria-label="Next">
