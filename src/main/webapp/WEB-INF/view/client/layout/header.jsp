   ...
   <!-- Navbar start -->
        ...
        <div class="container px-0 ">
            <nav class="navbar navbar-light bg-white navbar-expand-xl ">
                    ...
                    <a href="/login" style="color:white;font-weight:400;font-size:15px;" class=" btn btn-primary me-4 my-auto">
                        Đăng Nhập
                    </a>
                    <a href="/register" style="color:white;font-weight:400;font-size:15px" class=" btn btn-primary  my-auto">
                        Đăng Ký
                    </a>
